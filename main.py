...
def mult_lorentz(x,params):
    ...
    Parameters
    params: array
            [dc,amplitude,gamma,centre] --- This is the format of our input parameters
    ...
    n = round(np.size(params)/4) # Determines the number of single Lorentzians generated
...
# +
# In the project description it was asked to check whether this program works for points that are not homogeneously spaced.
# Thus we created an x range that is not homoegeously spaced.
...
# +
# This is the scipy peak finder function. WE use this function to determine the number of peaks.
# Prominance is the minimum height between the summit and any higher terrain. 
...
def start_val(general_gamma,peak_loc,dc,a):
    ...
    This function generates the initial guesses for each Lorentizain peak. 
    ...
    returns initial guesses as one array
...
print("Initial parameters",start)
...
# +
# Plotting of fitted function and raw data
